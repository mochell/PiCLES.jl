"""
Manual diagnostic: Cartesian grid construction checks.

Interactive script for visual and exploratory grid validation.
"""
...
GM_mask = TwoDCartesianGridMesh(grid_w_mask, G.stats, G.ProjetionKernel, G.PropagationCorrection)
