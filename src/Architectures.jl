...
#All possible types of a single-layer StateVectors in 2D
StateTypeL1 = Union{SharedArray{Float64,3},MArray}

StateTypeL1_1D = Union{SharedArray{Float64,2}}
